...
public:	
	...
	// H.265 MP 1920x1080@30FPS 2Mbps, 有I帧=67.927 KB的情况。
	...
	void printVencStreamInfo(const MI_VENC_Stream_t* pstVencStream);
	int rcvStream(MI_VENC_CHN vencChn, stStreamPack_t *pStreamPack);
