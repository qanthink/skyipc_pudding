...
public:
	...
	MI_S32 createStreamWithAttr(MI_VENC_CHN vencChn, MI_VENC_ChnAttr_t *pstChnAttr);
	...
	MI_VENC_ModType_e getVesType(MI_VENC_CHN vencChn);
	int setVesType(MI_VENC_CHN vencChn, MI_VENC_ModType_e vesType);

	int setResolution(MI_VENC_CHN vencCh, int width, int height);
	int getResolution(MI_VENC_CHN vencCh, int *pWidth, int *pHeight);
