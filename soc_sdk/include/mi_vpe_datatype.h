...
typedef enum
{
    ...
    E_MI_VPE_HDR_TYPE_SLF_LONG,
    E_MI_VPE_HDR_TYPE_SLF_SHORT,
...
/*
PortSrc from MI_VPE_PortSource_e
PortId from MI_VPE_OutputPortId_e
bit0~7  E_MI_VPE_PORTSRC_FRAME
bit8~15 E_MI_VPE_PORTSRC_YUV_REALTIME
bit16~23 E_MI_VPE_PORTSRC_BAYER_REALTIME
*/
