...
typedef struct MI_ISP_AWB_STABILIZER_INFO_s
{
    MI_U32 u32RefEnvRgain;
    MI_U32 u32RefEnvBgain;
    MI_U32 u32CurEnvRgain;
    MI_U32 u32CurEnvBgain;
} MI_ISP_AWB_STABILIZER_INFO_t;
