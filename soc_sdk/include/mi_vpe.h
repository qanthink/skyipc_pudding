...
MI_S32 MI_VPE_LoadPortZoomTable(MI_VPE_CHANNEL VpeCh, MI_VPE_OutputPortId_e VpePortMask, MI_VPE_ZoomTable_t *pZoomTable);
MI_S32 MI_VPE_StartPortZoom (MI_VPE_CHANNEL VpeCh, MI_VPE_OutputPortId_e VpePortMask, MI_VPE_ZoomAttr_t *pstZoomAttr);
MI_S32 MI_VPE_StopPortZoom (MI_VPE_CHANNEL VpeCh, MI_VPE_OutputPortId_e VpePortMask);
MI_S32 MI_VPE_GetPortCurZoomAttr (MI_VPE_CHANNEL VpeCh, MI_VPE_OutputPortId_e VpePort, MI_VPE_ZoomAttr_t *pstZoomAttr);
